...
class SequenceBuffer:
    def __init__(self, env_name, dataset, context_len, root_dir, sample_type='uniform', pos_encoding='absolute', seed=0) -> None:
        ...
        for i, traj in enumerate(trajectories):
            ...
            # note that the reward_to_go should be computed from the reward of each step using the `discounted_cumsum` function
